    ...
    <form class="section-main" @submit.prevent="formHandler">
        <div class="form-wrapper">
            <div class="container">
                ...
                <div class="form-submit full-row"><a class="site-btn" :href="route('companyAdmin.dashboard')">Cancel</a><input class="site-btn dark-btn submit" type="submit" :value="formData.id ? 'Update' : 'Create'"></div>
            </div>
        </div>
    </form>
</template>