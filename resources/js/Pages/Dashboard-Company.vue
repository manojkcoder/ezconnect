...
const loadUsers = async () => {
    const response = await fetch(route('companyAdmin.dashboard.get-users')); // Adjust route name if necessary
                ...
                <div class="dashLeft">
                    ...
                    <section class="section contactRequestSection">
                        <div class="container">
                            ...
                            <!-- <a v-if="contact_requests.length == 5" class="linktext" :href="route('contact-requests.index')">View All Connections</a> -->

                        </div>
                    </section>

                    <!-- Add this to your Vue template -->
