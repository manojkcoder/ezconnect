<script setup>
    ...
    const props = defineProps({
        formHandler: {type: Function,required: true},
...
<template>
    <form class="section-main" @submit.prevent="formHandler">
        <div class="form-wrapper">
            <div class="container">
                <SelectBox class="full-row" label="Company" type="text" name="company_id" v-model="formData.company_id" :error="formErrors.company_id?.pop()" :options="companies" required/>
