...
class SocialNetworksTableSeeder extends Seeder
{
    ...
    {
        $networks = [
            [ 'key' => 'facebook', 'name' => 'Facebook', 'icon' => 'facebook', 'type' => 'username' , 'format' => 'https://www.facebook.com/{value}'],
            [ 'key' => 'snapchat', 'name' => 'Snapchat', 'icon' => 'snapchat', 'type' => 'username' , 'format' => 'https://t.snapchat.com/{value}'],
            ...
            [ 'key' => 'youtube_channel', 'name' => 'Youtube Channel', 'icon' => 'youtube', 'type' => 'username' , 'format' => 'https://www.youtube.com/{value}'],
            ...
            [ 'key' => 'spotify', 'name' => 'Spotify', 'icon' => 'spotify', 'type' => 'username' , 'format' => 'https://open.spotify.com/user/{value}'],
            [ 'key' => 'skype', 'name' => 'Skype', 'icon' => 'skype', 'type' => 'username' , 'format' => 'https://join.skype.com/{value}'],
            ...
            [ 'key' => 'linkedin', 'name' => 'Linkedin', 'icon' => 'linkedin', 'type' => 'username' , 'format' => 'https://www.linkedin.com/in/{value}'],
